const albanianDict = {
    ...
    REGION_LABEL: 'Regjioni',

    REGION_TYPE_LABEL: 'Vendbanimi',
    ...
    PARTNER1_DESC:
        'BCSP (Belgrade Centre for Security Policy) është një think-tank i pavarur i themeluar në vitin 1997 me seli në Beograd – Serbi. BCSP është i përkushtuar për avancimin e sigurisë së qytetarëve dhe shoqërisë në bazë të parimeve demokratike dhe respektimit të të drejtave të njeriut.',

    PARTNER2: 'Qendra për Studimin e Demokracisë dhe Qeverisjes',

    PARTNER2_DESC:
        'CSDG është një organizatë e pavarur e shoqërisë civile e përkushtuar ndaj parimeve të jopartiake, jofitimprurëse dhe pavarësisë e themeluar në vitin 2010 dhe me qendër në Tiranë, Shqipëri. Misioni i saj është të përmirësojë demokracinë, qeverisjen dhe politikëbërjen në Shqipëri.',
...
const serbianDict = {
    ...
    REGION_TYPE_LABEL: 'Lokacija',

    NATIONALITY_LABEL: 'Nacionalnosti',

    GENDER_LABEL: 'Rodu',

    AGE_LABEL: 'Starosti',

    COUNTRIES: ['Kosovo', 'Albanije', 'Srbija'],
    ...
    PARTNER1_DESC:
        'BCBP je nezavisni tink-tenk osnovan 1997. godine, sa sedištem u Beogradu – Srbija. Posvećen je unapređenju bezbednosti građana i društva na osnovu demokratskih načela i poštovanja ljudskih prava.',
    PARTNER2_DESC:
        'CPDU je nezavisna i progresivna organizacija civilnog društva posvećena načelima nestranačke i nedobitne nezavisnosti osnovana 2010. godine, sa sedištem u Tirani, Albanija. Njegova misija je da unapredi demokratiju, upravljanje i kreiranje politike u Albaniji.',

    PARTNER2: 'Centar za proučavanje demokratije i upravljanja (CPDU)',
...
const englishDict = {
    ...
    ALBANIA_NATIONALITIES: ['All', 'Albanian', 'Greek', 'Macedonian', 'Arumun', 'Other'],

    SERBIA_NATIONALITIES: ['All', 'Serb', 'Slovak', 'Croatian', 'Hungarian', 'Bosniaks', 'Roma', 'I refuse to answer', 'Other'],
    ...
    PARTNER1_DESC:
        'BCSP is an independent think-tank founded in 1997 based in Belgrade – Serbia. It is dedicated to advancing security of the citizens and society on the basis of democratic principles and respect for human rights.',

    PARTNER2_DESC:
        'The CSDG is an independent civil society organization committed to the principles of non-partisanship, not-for-profit, and independence established in 2010 and based in Tirana, Albania. Its mission is to improve democracy, governance and policy making in Albania.',

    PARTNER2: 'Center for the Study of Democracy and Governance (CSDG)',
